...
/*单独删除*/
function cargoControldeleteConfirm(u) {
...
function cargoControlfinishConfirm(u) {
    layer.confirm('该记录已完成？', function () {
        $.ajax({
            type: "put",
            dataType: "json",
            url: u,
...
function cargoControl_del(t) {
    ...
    if (check) {
        ...
        layer.confirm('确认要删除选中的' + num + '个记录吗？', function () {
            $.ajax({
                type: "delete",
                dataType: "json",
                url: $(t).attr("_href"),
...
function cargoControl_fin(t) {
    ...
    if (check) {
        ...
        layer.confirm('确认已完成选中的' + num + '个记录吗？', function () {
            $.ajax({
                type: "put",
                dataType: "json",
                url: $(t).attr("_href"),
