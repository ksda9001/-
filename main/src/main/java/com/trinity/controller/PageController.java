...
import com.trinity.util.MarkdownUtil;
import com.trinity.util.ObjectUtil;
...
public class PageController {
    ...
    public ModelAndView blog_input() {
        ...
        mv.setViewName("main/admin/blog-input");
    ...
    public ModelAndView blogs() {
        ...
        map.put("begin", 0);
        map.put("size", 6);
        mv.setViewName("main/admin/blogs");
        mv.addObject("types", typeService.findTypeAll());
    ...
    public ModelAndView comments() {
        ...
        mv.setViewName("main/admin/comments");
        return getModelAndView(mv);
    }
    ...
    public ModelAndView comments_details(@PathVariable Integer id) {
        ...
        mv.setViewName("main/admin/comments-details");
        return getModelAndView(mv);
    }
    ...
    public ModelAndView tag_input() {
        ModelAndView mv = new ModelAndView();
        mv.addObject("method", "post");
        mv.setViewName("main/admin/tag-input");
        return getModelAndView(mv);
    }
    ...
    public ModelAndView tags() {
        ...
        mv.setViewName("main/admin/tags");
        return getModelAndView(mv);
    }
    ...
    public ModelAndView types() {
        ...
        mv.setViewName("main/admin/types");
        return getModelAndView(mv);
    }
    ...
    public ModelAndView types_input() {
        ModelAndView mv = new ModelAndView();
        mv.setViewName("main/admin/types-input");
        mv.addObject("method", "post");
        return getModelAndView(mv);
    }
